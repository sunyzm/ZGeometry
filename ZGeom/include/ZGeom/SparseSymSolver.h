...
namespace ZGeom
{
    ...
    public:
        ...
        SparseSymSolver() {}
        SparseSymSolver(const SparseMatrix<T>& mat, bool positive_definite, bool verbose = false);
        SparseSymSolver(MKL_INT ne, T* c, MKL_INT* ic, MKL_INT *jc, bool positive_definite = true, bool verbose = false);
        ~SparseSymSolver();
    ...
    template<typename T>
    inline SparseSymSolver<T>::SparseSymSolver(const SparseMatrix<T>& mat, bool positive_definite, bool verbose)
    {
    ...
    template<typename T>
    inline SparseSymSolver<T>::SparseSymSolver(MKL_INT ne, T *c, MKL_INT *ic, MKL_INT *jc, bool positive_definite, bool verbose)
    {
        initialize(ne, c, ic, jc, positive_definite, verbose);
    }

    template<typename T>
    inline SparseSymSolver<T>::~SparseSymSolver()
    {
        clear();
    }
